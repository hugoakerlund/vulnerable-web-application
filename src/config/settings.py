...
INSTALLED_APPS = [
    ...
    # FIX 2:  Add the axes app for account lockout and rate limiting
    # 'axes',  
]

# FIX 2: Add Axes settings for account lockout and rate limiting
...
MIDDLEWARE = [
    ...
    # FIX 2: Add the Axes middleware for account lockout and rate limiting
